...
Vendored from rlm-docsync. Uses only stdlib (no PyYAML) --
callers must pass parsed dicts or use load_manifest_from_dict.
"""
...
def load_manifest(path: str | Path) -> DocManifest:
    ...
    For YAML support, parse externally and call load_manifest_from_dict.
    """
